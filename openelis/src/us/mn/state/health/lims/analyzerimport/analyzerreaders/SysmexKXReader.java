...
public class SysmexKXReader extends AnalyzerLineInserter{
    ...
    private void addAnalyzerResults(List<AnalyzerResults> results, JSONObject json) throws ParseException, JSONException {
        ...
        MappedTestName mappedName = AnalyzerTestNameCache.instance().getMappedTest(AnalyzerTestNameCache.AnalyzerType.SYSMEX_KX, testName);
        if (mappedName == null) {
            mappedName = AnalyzerTestNameCache.instance().getEmptyMappedTestName(AnalyzerTestNameCache.AnalyzerType.SYSMEX_KX, testName);
        }
    ...
    public JSONObject getTestUnits() throws JSONException {
        ...
        testUnits.put("MXD#", "10^3/uL");
        testUnits.put("NEUT#", "10^3/uL");

        testUnits.put("RDW_SD", "fL");
        testUnits.put("RDW_CV", "%");
        testUnits.put("PDW", "fL");
