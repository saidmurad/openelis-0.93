...
public class DxhAllParametreReader extends AnalyzerLineInserter{
    ...
    private void addAnalyzerResults(List<AnalyzerResults> results, JSONObject json) throws ParseException, JSONException {
        ...
        for(int i=2; i < json.names().length() ; i++) {
            //JSONObject json = (JSONObject) json;
            String testName = json.names().getString(i);
            String result = json.getString(testName);
